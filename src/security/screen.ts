...
const RULES: Array<{ kind: ThreatKind; re: RegExp }> = [
  ...
  { kind: 'priority_manipulation', re: /\b(mark|set|make|change|raise|escalate)\b[^.\n]{0,40}\b(critical|urgent|top|highest)\b[^.\n]{0,15}\bpriority\b/i },
  { kind: 'priority_manipulation', re: /\bpriority\b[^.\n]{0,20}\b(to|as|=)\s*(critical|urgent|highest|top)\b/i },
  { kind: 'priority_manipulation', re: /\b(mark|set|make)\b[^.\n]{0,30}\b(this|task|job|request)\b[^.\n]{0,30}\b(critical|urgent)\b/i },
